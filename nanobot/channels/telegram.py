...
class TelegramChannel(BaseChannel):
    ...
    async def send(self, msg: OutboundMessage) -> None:
        ...
        if msg.content and msg.content != "[empty message]":
            ...
            for chunk in split_message(msg.content, TELEGRAM_MAX_MESSAGE_LEN):
                ...
                if not is_progress:
                    await self._send_with_streaming(chat_id, chunk, reply_params, thread_kwargs, reply_markup)
                else:
                    await self._send_text(chat_id, chunk, reply_params, thread_kwargs, reply_markup)
    ...
    async def _send_with_streaming(
        ...
        try:
            ...
            pass
        await self._send_text(chat_id, text, reply_params, thread_kwargs, reply_markup)
